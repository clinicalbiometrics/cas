...
Nachfolgend auf die Statusänderungen

-   transplantierbar

-   transplantierbar high-urgency

-   nicht transplantabel

können alle zur Auswahl stehenden Statusänderungen ausgewählt werden.
...
können keine weiteren Statusänderungen folgen, da nach diesen Statusänderungen eine neue [Episode](https://clinicalbiometrics.github.io/cas/episodes.html) beginnt.
...
2.  Patient verstorben: Durch die Auswahl "Ja" öffnen sich 2 neue Felder: "Todesdatum" und "Grund"
